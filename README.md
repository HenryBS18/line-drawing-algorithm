...
This website is used to calculate line from point A to point B with **Basic Gradient Algorithm**, **Digital Differential Analyzer (DDA)** and **Bressenham Algorithm**. Then visualize it into Cartesian Coordinates Chart.
